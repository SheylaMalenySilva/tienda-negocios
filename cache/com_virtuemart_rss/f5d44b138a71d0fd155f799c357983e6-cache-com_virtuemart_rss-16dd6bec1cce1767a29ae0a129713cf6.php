<?php die("Access Denied"); ?>#x#a:2:{s:6:"output";s:0:"";s:6:"result";a:5:{i:0;O:8:"stdClass":3:{s:4:"link";s:51:"http://virtuemart.net/news/491-bugfix-release-3-4-2";s:5:"title";s:20:"Bugfix release 3.4.2";s:11:"description";s:1240:"<p>This release primarily fixes a bug which affected some users when they updated their shop to VirtueMart 3.4.0. Third party developers should update their systemplugins loading the VirtueMartConfig class analogue to the virtuemart system plug-in. For details please use this <a href="http://forum.virtuemart.net/index.php?topic=141175.msg496861#msg496861">link to the forum thread</a></p>
...
<li>Products can be assigned a fixed Canonical Category &ndash; useful where a product is in multiple categories and the category name forms part of the product URL - product_canon_category_id.</li>
...
<li>For FE search of items - the product model no longer replaces the search character &ldquo;-&ldquo; with &ldquo;%&rdquo;.</li>
<li>Table change to products_language tables, &ldquo;product_desc&rdquo; now set as Datatype &ldquo;text&rdquo; (no varchars any longer).</li>
</ul>
...
<li>Customfields can have the same name using a hidden configuration &ldquo;unique_customfield_titles&rdquo; to disable &ldquo;unique names&rdquo;.</li>
...
<ul>
<li>Calculation of net price rounds final price first (prevents wrong inputs) &ndash; calculatorH.</li>
...
<li>ChangeShopperAlsoUseAdminShoppergroups - Add the shoppergroups of the logged in Admin user to the &ldquo;switched&rdquo; user&rsquo;s shoppergroups.</li>
<li>ChangeShopperDeleteCart - When a user is chosen by the admin &ndash; the cart contents are cleared &ndash; prevents accidental inclusion of cart items.</li>
</ul>
...
<li>The layout &lsquo;padded&rsquo; has a small update to show all quantity warnings in the popup.</li>
...
<li>Removed double id="reg_text", replaced with &ldquo;class.</li>
...
<li>PayPal hosted payment iframe little catch for EMAILLINK &ndash; handles no PayPal response.</li>
...
</ul>";}i:2;O:8:"stdClass":3:{s:4:"link";s:95:"http://virtuemart.net/news/489-virtuemart-3-2-14-security-release-and-enhanced-invoice-handling";s:5:"title";s:66:"VirtueMart 3.2.14 - Security Release and enhanced invoice handling";s:11:"description";s:2491:"<p>This fairly serious XSS discovered by Mattia Furlani pertained only the administration area, so most shops are not affected. Shop owners running a multi-vendor store or fearing that their employees may use this leak should update as soon as possible.</p>
